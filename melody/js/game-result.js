...
let ResultView$1 = class ResultView extends AbstractView {
  constructor(game) {
    super();
    this.game = game;
  }
...
class ResultScreen {
  constructor(model) {
    this.model = model;
    this.view = new ResultView$1(this.model.resultState);
...
let ResultScreen$1 = class ResultScreen {
  constructor(gameState) {
...
return ResultScreen$1;

}());

//# sourceMappingURL=game-result.js.map
